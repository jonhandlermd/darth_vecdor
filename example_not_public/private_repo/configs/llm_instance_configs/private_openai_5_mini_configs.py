...
llm_settings['model'] = 'gpt-5-mini'  # Always need a model (formerly called "engine")
...
# request_settings['temperature'] = 0  # ChatGPT 5 mini only supports default value (1)
# request_settings['text'] = {"verbosity": 'low'}
request_settings['max_completion_tokens'] = 4096
# request_settings['stop'] = '' # Not supported in gpt 5 mini
